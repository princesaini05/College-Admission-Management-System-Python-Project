...
def new_admin():
    ...
    A=Label(Admin,text="Add New Admin",font="Arial 22 bold")
    A.place(x=200,y=50)

    A1=Label(Admin,text="New Admin",font="Arial 18 bold")
    A1.place(x=80,y=150)
    EA1=Entry(Admin,font="Arial 18 bold")
    EA1.place(x=250,y=150)

    A2=Label(Admin,text="Password",font="Arial 18 bold")
    A2.place(x=80,y=200)
    EA2=Entry(Admin,font="Arial 18 bold")
    EA2.place(x=250,y=200)
    ...
    def save_button():
        ...
        db=sql.connect(host="localhost",user="root",password="Prince9084#",db="clg")
        cur=db.cursor()
        result=cur.execute("""INSERT INTO admin VALUES(%s,%s,%s)""",(k,k1,'admin'))
        EA1.delete(0,END)
        EA2.delete(0,END)
        if (result>0):
        ...
        db.close()
        Admin.destroy()
    B8=Button(Admin,text="Save",font="arial 12 bold",command=save_button)
    B8.place(x=300,y=250)
...
B7=Button(top,text="Add New Admin",font=("arial 10 bold"),command=new_admin)
B7.place(x=850,y=50)

B8=Button(top,text="Manage Admin",font=("arial 10 bold"),command=manage_admin)
B8.place(x=850,y=90)
